...
public interface IGraph {
	...
	/**
	 * Use Coordinator Election Algorithm in Wireless Environments to find coordinator of the graph
	 * as highest capacity vertex and let all vertices to know the coordinator.
	 * 
	 * It will work as a simulation.  
	 *
	 * @param vertexValue
	 */
	void electionCoordinator(String vertexValue);
}